...
namespace ListFilterer.Test
{
    ...
    public class ListFilterer
    {
        ...
        public void GetIntegersFromList_MixedValues_ShouldPass_1()
        {
            ...
            var actual = global::ListFilterer.ListFilterer.GetIntegersFromList(list);
      ...
      "Hello!!!!", "!!!! World!", "Raw", "Danger", "Is", "The", "Best", "PS2", "Game", "Disaster", "Report", "Is", "Alright", "I", "Guess",
        ...
        public void GetIntegersFromList_RandomTest()
        {
            const int Tests = 100;
            ...
            for (int i = 0; i < Tests; ++i)
            {
                ...
                IEnumerable<int> actual = global::ListFilterer.ListFilterer.GetIntegersFromList(testCase);
